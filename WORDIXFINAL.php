  ...
  {    
    ...
    foreach ($letras as $letra) {
        ...
        if ((in_array($letra, ['A', 'E', 'I', 'O', 'U']))==true) {
            // Vocales
            $puntaje=$puntaje+1;
        } elseif ((in_array($letra, ['B','C','D','F','G','H','J','K','L','M']))==true) {
            // Consonantes anteriores o iguales a 'M'
            $puntaje = $puntaje + 2;
        } elseif ((in_array($letra, ['N','Ñ','P','Q','R','S','T','V','X','Z','W,','Y']))==true){
            // Consonantes posteriores a 'M'
            $puntaje = $puntaje + 3;
        }
    }
